...
class GitHubService:
    ...
    async def analyze_github_profile(
        ...
        try:
            ...
            logger.info(f"✅ Skills extracted:")
            ...
            logger.info(f"✅ Commit analysis results:")
    ...
    async def _analyze_languages(self, repositories: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for lang_data in language_stats.values():
            lang_data["percentage"] = (
                lang_data["repository_count"] / total_repos * 100) if total_repos > 0 else 0

        # Sort by repository count
        return sorted(language_stats.values(), key=lambda x: x["repository_count"], reverse=True)
    ...
    async def _extract_skills(self, user_data: Dict[str, Any], repositories: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        languages = {repo.get("language")
                     for repo in repositories if repo.get("language")}
        ...
        for repo in repositories:
            ...
            if description:
                ...
                # Common frameworks
                framework_keywords = ["react", "vue", "angular",
                ...
                # Common tools
                tool_keywords = ["docker", "kubernetes", "aws", "gcp",
                                 "azure", "jenkins", "git", "mongodb", "postgresql"]
                for keyword in tool_keywords:
                    if keyword in description_lower:
                        tools.add(keyword.upper() if keyword in [
                                  "aws", "gcp"] else keyword.title())
    ...
    async def _analyze_commits(self, username: str, repositories: List[Dict[str, Any]], max_commits: int = 150) -> Dict[str, Any]:
        ...
        try:
            ...
            repo_batches = [repositories[i:i + self.REPOSITORY_BATCH_SIZE] 
                           for i in range(0, len(repositories), self.REPOSITORY_BATCH_SIZE)]
            ...
            logger.info(f"🎉 COMMIT COLLECTION COMPLETED")
    ...
    def _calculate_contributor_optimal_commits_per_repo(self, total_repos: int, max_commits: int) -> int:
        ...
        optimal = max(min_commits_per_repo, min(ideal_per_repo, self.MAX_COMMITS_PER_REPO))
    ...
    def _analyze_excellence_patterns(self, commit_messages: List[str]) -> Dict[str, Any]:
        ...
        excellence_keywords = {
            "bug_fixing": ["fix", "bug", "resolve", "patch", "correct", "debug"],
            "feature_development": ["add", "implement", "create", "build", "develop", "feature"],
            "optimization": ["optimize", "improve", "enhance", "performance", "speed", "efficient"],
            ...
            "ui_ux": ["ui", "ux", "interface", "design", "styling", "css", "frontend"]
        }
        ...
        for category, keywords in excellence_keywords.items():
            count = sum(1 for message in commit_messages 
    ...
    def _analyze_tools_and_features(self, commit_messages: List[str]) -> Dict[str, Any]:
        ...
        tool_patterns = {
            "databases": ["sql", "mongodb", "postgres", "mysql", "redis", "sqlite"],
            "frameworks": ["react", "vue", "angular", "django", "flask", "express", "spring"],
            "cloud_services": ["aws", "azure", "gcp", "docker", "kubernetes", "heroku"],
            "testing_tools": ["jest", "pytest", "mocha", "cypress", "selenium"],
            "build_tools": ["webpack", "vite", "gulp", "grunt", "maven", "gradle"],
            "monitoring": ["logging", "monitoring", "metrics", "analytics", "sentry"]
        }
    ...
    def _analyze_commit_patterns(self, commits: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        dates = [datetime.fromisoformat(commit["date"].replace('Z', '+00:00')) 
                for commit in commits if commit["date"]]
    ...
    def _analyze_technical_contributions(self, commit_messages: List[str]) -> Dict[str, Any]:
        ...
        technical_indicators = {
            ...
            "performance": ["performance", "optimization", "caching", "lazy loading"],
            "scalability": ["scalable", "scale", "horizontal", "vertical", "load"],
            "maintainability": ["maintainable", "clean code", "readable", "modular"],
            "integration": ["api", "integration", "webhook", "service", "endpoint"]
        }
    ...
    def _empty_commit_analysis(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "tools_and_features": {"tools_by_category": {}, "features_implemented": {}, "total_unique_tools": 0},
            "commit_patterns": {},
    ...
    async def _extract_repository_skills(self, repo_info: Dict[str, Any], languages: List[Dict[str, Any]], commits: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        try:
            ...
            domain_keywords = {
                "Web Development": ["web", "frontend", "backend", "fullstack", "website", "application"],
                "Mobile Development": ["mobile", "android", "ios", "react native", "flutter", "swift"],
                "Data Science": ["data", "machine learning", "ml", "ai", "analytics", "visualization"],
                "DevOps": ["devops", "ci/cd", "deployment", "infrastructure", "automation"],
                "API Development": ["api", "rest", "graphql", "microservice", "backend"],
    ...
    async def _analyze_repository_commit_patterns(self, commits: List[Dict[str, Any]], languages: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        try:
            ...
            message_patterns = {
                "feature_development": ["add", "feature", "implement", "create", "new"],
                "bug_fixes": ["fix", "bug", "issue", "resolve", "correct"],
                "refactoring": ["refactor", "clean", "improve", "optimize", "update"],

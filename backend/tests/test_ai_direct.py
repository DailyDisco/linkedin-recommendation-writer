...
async def test_ai_generation():
    ...
    github_data = {
        ...
        "repository_info": {"name": "smart-gym", "description": "A fitness tracking application", "language": "TypeScript"},
        "languages": [{"language": "TypeScript", "percentage": 60.0}],
        "skills": {"technical_skills": ["React", "TypeScript", "Node.js"], "frameworks": ["React", "Express"], "domains": ["Web Development"]},
    ...
    try:
        result = await ai_service._generate_single_option(
            ...
            length="medium",
            generation_params={"github_username": "rajakrishna", "recommendation_type": "professional", "tone": "professional", "length": "medium", "focus": "technical_expertise"},
        )

...
def upgrade() -> None:
    ...
    # Add credits fields to users table
    op.add_column('users', sa.Column('credits', sa.Integer(),
                                      nullable=False, server_default='3'))
    op.add_column('users', sa.Column('lifetime_credits_purchased', sa.Integer(),
    ...
    op.create_index('idx_credit_purchases_stripe_session', 'credit_purchases',

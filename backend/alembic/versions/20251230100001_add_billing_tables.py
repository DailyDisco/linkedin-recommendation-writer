...
def upgrade() -> None:
    ...
    op.create_index("idx_subscriptions_stripe_customer_id", "subscriptions", ["stripe_customer_id"], unique=True)
    op.create_index("idx_subscriptions_stripe_subscription_id", "subscriptions", ["stripe_subscription_id"], unique=True)
    ...
    op.create_index("idx_usage_records_user_date", "usage_records", ["user_id", "date"], unique=True)
    ...
    op.create_index("idx_webhook_events_stripe_id", "stripe_webhook_events", ["stripe_event_id"], unique=True)

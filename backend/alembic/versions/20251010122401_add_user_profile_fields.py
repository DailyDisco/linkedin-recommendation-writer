...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('email_notifications_enabled', sa.Boolean(), 
                                      nullable=False, server_default='true'))
    
    # Add default_tone column (varchar with default 'professional')
    op.add_column('users', sa.Column('default_tone', sa.String(), 
                                      nullable=False, server_default='professional'))
    
    # Add language column (varchar with default 'en')
    op.add_column('users', sa.Column('language', sa.String(), 
